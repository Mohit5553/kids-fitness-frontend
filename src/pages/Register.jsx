    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between pt-6">
        ...
        <button
          type="submit"
          disabled={uploading}
          className="rounded-full bg-coral px-12 py-4 text-base font-black text-white shadow-xl hover:scale-105 transition-transform active:scale-95 disabled:opacity-50"
        >
          {uploading ? 'Finalizing...' : 'Complete Registration'}
        </button>
      </div>
    </div>
  );
