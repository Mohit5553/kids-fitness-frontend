          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-[40px] shadow-2xl shadow-brand-blue/5 border border-brand-blue/10 p-10 overflow-hidden relative">
            <div className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-2xl bg-brand-blue py-4 text-sm font-black text-white shadow-xl shadow-brand-blue/20 hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:scale-100 transition-all"
              >
